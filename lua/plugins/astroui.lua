  ...
  opts = {
    ...
    highlights = {
      init = {
        ...
        -- NeoTreeTabInactive = { bg = "#1e1e2e" },
        -- NeoTreeTabSeperatorActive = { fg = "#F2F3F5", bg = "#1e1e2e" },
        -- NeoTreeTabSeperatorInactive = { fg = "#F2F3F5", bg = "#1e1e2e" },
        -- NvimTreeTabSeperatorActive = { fg = "#F2F3F5", bg = "#1e1e2e" },
        -- NvimTreeTabSeperatorInactive = { fg = "#F2F3F5", bg = "#1e1e2e" },
        -- MiniTabLineFill = { fg = "#F2F3F5", bg = "#1e1e2e" },
